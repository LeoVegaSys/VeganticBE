...
class DataFormatter:
    ...
    def format_data_for_visualization(self, state: dict) -> dict:
        ...
        print(f"format_data_for_visualization :: state : {state}")
    ...
    def _format_other_visualizations(self, visualization, question, sql_query, results):
        ...
        try:
            print(f"_format_other_visualizations :: resp :: {response}")
            ...
            print(f"_format_other_visualizations :: Exp")
